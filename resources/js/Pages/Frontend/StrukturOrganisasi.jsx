...
const kolektor = [
    {
        nama: "Kolektor Wilayah 1",
        jabatan: "Kolektor",
        nip: "19xxxxxxxxxxxxxxxx",
        photoUrl: null,
    },
    {
        nama: "Kolektor Wilayah 2",
        jabatan: "Kolektor",
        nip: "19xxxxxxxxxxxxxxxx",
        photoUrl: null,
    },
    {
        nama: "Kolektor Wilayah 3",
        jabatan: "Kolektor",
        nip: "19xxxxxxxxxxxxxxxx",
        photoUrl: null,
    },
    {
        nama: "Kolektor Wilayah 4",
        jabatan: "Kolektor",
        nip: "19xxxxxxxxxxxxxxxx",
        photoUrl: null,
    },
            ...
            <section className="bg-gradient-to-b from-blue-900 to-blue-700 px-4 pb-10 pt-6">
                <div className="mx-auto max-w-6xl">
                    ...
                    <p className="mt-2 max-w-lg text-sm text-blue-100">
                        Susunan pimpinan, tata usaha, dan petugas kolektor UPTD
            ...
            <main className="mx-auto max-w-6xl space-y-12 px-4 py-10">
                ...
                <section>
                    <div className="mb-4 flex items-end justify-between">
                        ...
                        <a
                            href="#galeri"
                            className="flex items-center text-xs font-semibold text-blue-700"
                        >
                            Lihat galeri{" "}
            ...
            <footer className="border-t border-slate-200 bg-white">
                <div className="mx-auto max-w-6xl px-4 py-10">
                    <div className="grid gap-8 sm:grid-cols-3">
                        ...
                        <div className="space-y-2 text-sm text-slate-600">
                            <div className="flex items-start gap-2">
                                ...
                                <span>
                                    Kantor UPTD Parkir, Kab. Tasikmalaya (alamat
                                    lengkap — menyusul)
                                </span>
                            </div>
                    ...
                    <div className="mt-8 border-t border-slate-100 pt-6 text-center text-xs text-slate-400">
                        © 2026 UPTD Pengelola Parkir · Pemerintah Kabupaten
                        Tasikmalaya
                    </div>
                </div>
            </footer>
